...
export const Step4 = forwardRef(({ setAnswerGlobal }, ref) => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios({
                    method: 'options',
                    url: 'https://fobi-app-cms7.onrender.com/api/fobi-form-entry/form4/',
                });
    ...
    const handleSubmit = () => {
        return new Promise((resolve, reject) => {
            if (validateForm()) {
                axios.put('https://fobi-app-cms7.onrender.com/api/fobi-form-entry/form4/', answers)
                    .then(response => {
